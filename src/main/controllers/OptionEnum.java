...
public enum OptionEnum {
    ...
    PILE_TO_LADDER(4, "Mover de descarte a escalera", new MovePileToLadderController()),
    ...
    FOUNDATION_TO_LADDER(7, "Mover de palo a escalera", new MoveFoundationToLadderController()),
